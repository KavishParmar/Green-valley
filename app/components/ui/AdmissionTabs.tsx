...
export default function AdmissionTabs({ steps = defaultSteps, onApplyClick }: AdmissionTabsProps) {
                ...
                return (
                    <div className="tab-content animate-fade">
                        ...
                        <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "1rem", lineHeight: 1.7, marginBottom: "2rem" }}>
                            At Green Valley Coaching Institute, we value merit and strive to make quality education accessible to every deserving student. Our scholarship programs reward academic excellence and provide financial support to talented aspirants.
                        </p>
                    ...
                    <div className="tab-content animate-fade">
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                            ...
                            <FaqItem
                                ...
                                a="Yes, but we recommend joining within the first 15 days of a new batch. Cover-up classes are provided for students who join late."
                            />
                            <FaqItem
                                q="Is there a hostel facility near the institute?"
                                a="We assist students in finding safe and reliable hostel/PG accommodation in close proximity to our Sehore campus."
                            />
                            <FaqItem
                                q="Are there any weekend batches available?"
                                a="Currently, we focus on regular full-time batches to ensure dedicated preparation and consistent performance tracking."
                            />
                        </div>
                    </div>
                );
        ...
        <div style={{ width: "100%", maxWidth: "1100px", margin: "4rem auto" }}>
            ...
            <style jsx>{`
                ...
                @media (max-width: 768px) {
                    .tab-header { padding: 0.5rem; gap: 0.25rem; }
                    .tab-header button { padding: 0.8rem; font-size: 0.9rem; min-width: 140px; }
                    div[style*="padding: 4rem 3rem"] { padding: 2.5rem 1.5rem !important; }
                }
            `}</style>
        </div>
    );
...
const FaqItem = ({ q, a }: { q: string; a: string }) => {
    ...
    return (
        ...
        >
            ...
            {open && (
                <div style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.95rem", marginTop: "0.85rem", lineHeight: 1.7 }}>{a}</div>
            )}
        </div>
    );
};
